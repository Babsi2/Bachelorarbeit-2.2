...
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {4}Einbindung Less}{9}{lstlisting.4}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5}Code in urspr\IeC {\"u}nglicher Syntax}{10}{lstlisting.5}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {6}Code mit in scss Syntax}{10}{lstlisting.6}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {7}style.styl}{12}{lstlisting.7}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8}variables.scss}{13}{lstlisting.8}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {9}style.scss}{13}{lstlisting.9}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {10}Mixin}{14}{lstlisting.10}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {11}Mixin Ausgabe}{14}{lstlisting.11}
\defcounter {refsection}{0}\relax 
...
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {15}Mixin mit Selector}{16}{lstlisting.15}
\defcounter {refsection}{0}\relax 
